...
@Tag(name = "CRUD REST APIs for Accounts", description = "CREATE, READ, UPDATE, DELETE Accounts")
@RestController
...
public class AccountController {
  ...
  private ResponseEntity<ResponseDto<?>> registerAccount(
      @RequestBody AccountKeyCloakRequest accountRequest) {
  ...
  private ResponseEntity<ResponseDto<?>> registerAccount(
      @RequestBody @Validated(ValidationGroups.OnCreate.class) AccountRequest accountRequest) {
    return ResponseEntity
        .status(HttpStatus.OK)
        .body(ResponseDto.builder()
            .statusMessage(AccountConstant.ACCOUNT_CREATED)
  ...
  public ResponseEntity<?> updateAccountProfile(
      @RequestBody @Validated(ValidationGroups.OnUpdate.class) AccountRequest accountRequest) {
    try {
  ...
  public ResponseEntity<AssignRole> assignRole(@RequestBody AccountRequest accountRequest,
  ...
  public ResponseEntity<AssignRole> unAssignRole(@RequestBody AccountRequest accountRequest,
      @RequestParam String roleName) {
    return ResponseEntity
        .status(HttpStatus.OK)
        .body(accountService.assignRole(accountRequest.getUsername(), roleName));
